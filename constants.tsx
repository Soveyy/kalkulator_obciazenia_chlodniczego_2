...
export const WALL_MATERIALS: { [key: string]: { label: string, absorptance: number } } = {
    ...
    metal_coated_light: { label: 'Blacha powlekana (jasna)', absorptance: 0.40 },
    metal_coated_dark: { label: 'Blacha powlekana (ciemna)', absorptance: 0.80 },
    roof_membrane_dark: { label: 'Papa / membrana bitumiczna (ciemna)', absorptance: 0.90 },
    roof_tile_red: { label: 'Dachówka ceramiczna (czerwona)', absorptance: 0.70 },
